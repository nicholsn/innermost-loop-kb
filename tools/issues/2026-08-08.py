...
""",
    ...
    "systems": [
        {"id": "poetiq-metasystem", "type": "AISystem", "title": "Poetiq Metasystem",
         "developed_by": [B + "organizations/poetiq"], "modality": "research agent",
         "description": "Poetiq's self-optimizing optimizer, a meta-system that improves its own harnesses, prompts and code rather than model weights and claims state of the art on six unseen benchmarks with no human intervention.",
         "resource": "https://poetiq.ai/posts/rsi_perspective/",
         "tags": ["research-agent"],
         "body": "Poetiq describes the Metasystem as a self-optimizing optimizer: every problem, task and dataset it "
                 "optimizes also helps it optimize itself, and what improves in each iteration is the whole reasoning "
                 "system of code, prompts and exploration strategies rather than the underlying model's weights "
                 "([Poetiq](https://poetiq.ai/posts/rsi_perspective/)). It is the successor to the "
                 "[Poetiq harness](/systems/poetiq-harness.md) that lifted base models on ARC-AGI-2 in late 2025 and "
                 "[took 55% on Humanity's Last Exam](/developments/2026-02-11-poetiq-55pct-hle.md); its "
                 "[August 2026 unveiling](/developments/2026-08-08-a-self-optimizing-optimizer.md) claimed SOTA on six "
                 "unseen benchmarks with zero human intervention."},
    ],
    "developments": [
        ...
        {"id": "2026-08-08-a-self-optimizing-optimizer",
         ...
         "description": "The harness-as-generalizer thesis becomes a company's entire strategy, the newsletter's "
                        "'curriculum is getting spicy' issue setting it beside OpenAI slowing Astra over cyber gains "
                        "from the same kind of loop.",
         ...
         "about": [B + "systems/poetiq-metasystem"],
         "supersedes": [B + "developments/2026-08-05-an-open-agent-passes-the-human-expert-baseline",
                        B + "developments/2026-02-11-poetiq-55pct-hle",
                        B + "developments/2026-06-25-an-agent-rewrites-its-own-harness"],
         "relatedTo": [B + "developments/2026-07-08-the-loop-optimizes-whatever-signal-you-give-it",
                       B + "developments/2026-05-11-the-harness-eats-the-model",
                       B + "developments/2026-07-15-the-first-evidence-of-consistent-recursive-self-improvement"],
         "relations": [{"predicate": "relatedTo",
                        "target": B + "developments/2026-07-15-the-first-evidence-of-consistent-recursive-self-improvement",
                        "relation_label": "corroborates"}],
         "tags": ["rsi", "self-modification", "agent-harness", "autonomous-research"],
         "supporting_text": "claiming SOTA on six unseen benchmarks with zero human intervention",
         "sources": [{"id": "poetiq-rsi-perspective",
                      "resource": "https://poetiq.ai/posts/rsi_perspective/",
                      "title": "A Poetiq Perspective on Recursive Self-Improvement", "author": "org:poetiq",
                      "last_modified": "2026-08-04"}],
         "verified": [{"by": "claude-fable-5-1/2026-09-17", "at": "2026-09-17T08:00:00Z"}],
         "body": "Poetiq's essay argues that recursive self-improvement is the fastest path to superintelligence and, "
                 "for the first time, describes its approach: the [Metasystem](/systems/poetiq-metasystem.md) is a "
                 "self-optimizing optimizer in which every problem it optimizes also improves the optimizer itself "
                 "([Poetiq](https://poetiq.ai/posts/rsi_perspective/)). What changes each iteration is the reasoning "
                 "system of harnesses, prompts, code and exploration strategies rather than model weights, and the "
                 "company claims state of the art on six benchmarks it had not seen, with zero human intervention. "
                 "It sits in the [self-authored-scaffolding](/themes/self-authored-scaffolding.md) line that runs from "
                 "[an agent rewriting its own harness](/developments/2026-06-25-an-agent-rewrites-its-own-harness.md) "
                 "through [Prime Agent's self-rewriting run on ARC-AGI-3](/developments/2026-08-05-an-open-agent-passes-the-human-expert-baseline.md), "
                 "and it makes at the harness layer the claim [Weco AI](/organizations/weco-ai.md) made "
                 "[at the researcher layer](/developments/2026-07-15-the-first-evidence-of-consistent-recursive-self-improvement.md) "
                 "three weeks earlier; five days later the harness-over-weights thesis is restated from the other "
                 "direction when [stock Claude Code turns 30% into 96.2%](/developments/2026-08-13-ninety-six-percent-with-stock-tooling-for-five-hundred-dollars.md) "
                 "on ARC-AGI-3."},
