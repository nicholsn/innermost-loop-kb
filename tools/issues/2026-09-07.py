...
""",
    ...
    "developments": [
        {"id": "2026-09-07-three-agent-workdays-per-human-workday",
         ...
         "description": "The first quantified exchange rate between automated and human research "
                        "labour, which turns the loop from a claim into a unit that can be tracked "
                        "and forecast.",
         ...
         "relatedTo": [B + "developments/2026-08-15-the-r-and-d-evals-have-saturated",
                       B + "developments/2026-04-08-research-sped-up-400x",
                       B + "developments/2026-01-09-openai-eight-months-to-intern-researchers"],
         "tags": ["rsi", "ai-r-and-d", "forecast", "evaluation"],
         "supporting_text": "3.1 agent-workdays per human workday",
         "sources": [{"id": "openai-research-acceleration-view-inside",
                      "resource": "https://openai.com/index/research-acceleration-view-inside-openai/",
                      "title": "Research acceleration: a view inside OpenAI", "author": "org:openai"},
                     {"id": "scaling01-time-horizons-6-18x-x",
                      "resource": "https://x.com/scaling01/status/2096636963772117205",
                      "title": "Post on X: OpenAI's internal time horizons are up 6.18x since January, "
                               "doubling every 2.2 months",
                      "author": "human:scaling01"},
                     {"id": "rynorhn-biggest-shift-in-history-of-science-x",
                      "resource": "https://x.com/rynorhn/status/2096685038901264438",
                      "title": "Post on X ranking the shift among the biggest in the history of science",
                      "author": "human:rynorhn"}],
         "verified": [{"by": "claude-fable-5-1/2026-09-17", "at": "2026-09-17T08:00:00Z"}],
         "body": "OpenAI's post *Research acceleration: a view inside OpenAI* "
                 "([openai.com](https://openai.com/index/research-acceleration-view-inside-openai/)) "
                 "reports the automated research intern delivering 3.1 agent-workdays per human "
                 "workday, up from under one before June, and sets March 2028 as the target for a "
                 "fully automated researcher; a separate analysis put "
                 "[internal time horizons up 6.18x since January](https://x.com/scaling01/status/2096636963772117205), "
                 "a doubling every 2.2 months. One observer ranked the shift "
                 "[among the biggest in the history of science](https://x.com/rynorhn/status/2096685038901264438), "
                 "and unnoticed by most. It is the delivery on the "
                 "[research intern by September](/developments/2026-03-22-openai-targets-a-research-intern-by-september.md) "
                 "that OpenAI promised in March and the "
                 "[automated researcher by March 2028](/developments/2026-06-09-a-personal-agi-for-every-human.md) "
                 "it planned in June, and it gives a unit to the loop the previous day's "
                 "[AGI ship date](/developments/2026-09-06-a-ship-date-for-agi.md) described, a "
                 "month after the lab said its "
                 "[R&D evaluations had saturated](/developments/2026-08-15-the-r-and-d-evals-have-saturated.md)."},
