...
""",
    ...
    "developments": [
        {"id": "2026-01-04-musk-enters-the-singularity",
         ...
         "claim": "Elon Musk stated that we have entered the Singularity and its recursive "
                  "self-improvement phase.",
         "domain": "society", "evidences": ["takeoff-declared", "recursive-self-improvement"],
         "supersedes": [B + "developments/2025-12-28-esr-singularity-upon-us"],
         "body": "The fifth declaration in three weeks, after Roon, Raymond, Yudkowsky and Altman."},
        ...
        {"id": "2026-01-04-rlm-two-orders-of-context",
         ...
         "domain": "agents", "about": [B + "systems/recursive-language-model"],
