...
""",
    ...
    "developments": [
        ...
        {"id": "2026-05-05-sixty-percent-odds-on-rsi-by-2028",
         ...
         "description": "A forecast with a number and a date from inside the lab that had, two "
                        "months earlier, described the loop as already under way.",
         ...
         "references": [B + "developments/2026-03-16-rsi-is-a-present-phenomenon"],
         "relatedTo": [B + "developments/2026-04-03-forecasts-move-eighteen-months-in-three",
                       B + "developments/2026-02-11-xai-cofounder-resigns-warning",
                       B + "developments/2025-12-31-asi-gap-july-2034"],
         "relations": [{"predicate": "references",
                        "target": B + "developments/2026-03-16-rsi-is-a-present-phenomenon",
                        "relation_label": "extends"}],
         "tags": ["rsi", "forecast"],
         "supporting_text": "the odds of recursive self-improvement by the end of 2028 at 60%",
         "sources": [{"id": "clark-rsi-sixty-percent-by-2028-x",
                      "resource": "https://x.com/jackclarkSF/status/2051312759594471886",
                      "title": "Jack Clark on X: 60% odds of recursive self-improvement by the end of 2028",
                      "author": "human:jack-clark"}],
         "verified": [{"by": "claude-fable-5-1/2026-09-17", "at": "2026-09-17T08:00:00Z"}],
         "body": "In [March](/developments/2026-03-16-rsi-is-a-present-phenomenon.md) the company's "
                 "alignment lead called it a present phenomenon. Here its co-founder quotes a "
                 "probability and a date: [Jack Clark](/people/jack-clark.md) put the odds of recursive "
                 "self-improvement arriving by the end of 2028 at 60%, grounding the number in hundreds "
                 "of public data sources ([X](https://x.com/jackclarkSF/status/2051312759594471886)), "
                 "where in [January](/developments/2026-01-10-clark-ai-doing-ai-research.md) he had "
                 "reported only early signs of AI doing components of AI research. The figure lands a "
                 "day after OpenAI's president put the distance to AGI at "
                 "[80%](/developments/2026-05-04-eighty-percent-of-the-way-to-agi.md) and a month after "
                 "the AI 2027 authors [pulled their timelines forward](/developments/2026-04-03-forecasts-move-eighteen-months-in-three.md); "
                 "the lab's own institute made the evidential case in June in "
                 "[When AI builds itself](/developments/2026-06-05-when-ai-builds-itself.md), which "
