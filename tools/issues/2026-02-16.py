...
""",
    ...
    "people": [
        ...
        {"id": "koushik-sen", "type": "Person", "title": "Koushik Sen",
         "name": "Koushik Sen",
         "description": "UC Berkeley researcher who let the Repo Optimizer agent of his KISS "
                        "multi-agent framework cut its own running cost by 98% overnight.",
         "resource": "https://dev.to/koushik_sen_d549bf321e6fb",
         "tags": ["researcher"],
         "body": "Koushik Sen maintains KISS, a minimalist multi-agent framework, and wrote up the "
                 "overnight run in which its Repo Optimizer agent edited its own code against a "
                 "cost target. In this corpus he appears once, as the Berkeley researcher behind "
                 "the [98% self-optimization](/developments/2026-02-16-agent-cuts-its-own-cost-98pct.md), "
                 "an early instance of an agent applying the optimization loop to itself."},
    ],
    "roles": [
        {"id": "koushik-sen-uc-berkeley-researcher", "type": "Role",
         "title": "Koushik Sen, researcher at UC Berkeley",
         "roleName": "Researcher",
         "memberOf": [B + "organizations/uc-berkeley"],
         "holder": [B + "people/koushik-sen"],
         "description": "The position in which the newsletter reports him letting his coding agent "
                        "cut its own cost overnight.",
         "body": "The newsletter identifies him only as a Berkeley researcher; the linked write-up "
                 "is his own account of the "
                 "[Repo Optimizer run](/developments/2026-02-16-agent-cuts-its-own-cost-98pct.md), "
                 "and his GitHub profile, reached through the write-up's link to the KISS "
                 "repository, gives his affiliation as UC Berkeley "
                 "([profile](https://github.com/ksenxx))."},
    ],
    "developments": [
        ...
        {"id": "2026-02-16-agent-cuts-its-own-cost-98pct",
         ...
         "claim": "A Berkeley researcher told his coding agent to cut its own cost by 99%, and "
                  ...
                  "wrote.",
         "description": "The newsletter's first case of a coding agent turning the optimization "
                        "loop on itself with a measured result: an unattended, metric-driven "
                        "self-edit whose gain no human authored.",
         "domain": "agents", "actor": ["uc-berkeley", "people/koushik-sen"], "score": "-98%",
         ...
         "supporting_text": "delivering a 98% cost cut across nine changes no human wrote",
         "sources": [{"id": "koushik-sen-repo-optimizer-devto",
                      "resource": "https://dev.to/koushik_sen_d549bf321e6fb/repo-optimizer-i-let-a-kiss-ai-agent-optimize-itself-overnight-it-cut-its-own-cost-by-98-1ddi",
                      "title": "Repo Optimizer: I Let a KISS AI Agent Optimize Itself Overnight. It Cut Its Own Cost by 98%.",
                      "author": "human:koushik-sen", "last_modified": "2026-02-22"}],
         "verified": [{"by": "claude-fable-5-1/2026-09-17", "at": "2026-09-17T08:00:00Z"}],
         "body": "Koushik Sen gave the Repo Optimizer agent of his minimalist KISS multi-agent "
                 "framework a single plain-English target, a 99% cost reduction, and let it run "
                 "overnight: it read its own logs, edited its own code, re-ran its benchmarks and "
                 "kept the edits that moved the metric "
                 "([write-up](https://dev.to/koushik_sen_d549bf321e6fb/repo-optimizer-i-let-a-kiss-ai-agent-optimize-itself-overnight-it-cut-its-own-cost-by-98-1ddi)). "
                 "The nine autonomous changes, the largest a switch from Claude Sonnet 4.5 to "
                 "[Gemini 2.5 Flash](/systems/gemini-2-5-flash.md), landed at 98% with the "
                 "framework's benchmark tests still passing. It sits between "
                 "[Factory AI's daily self-rewriting agent](/developments/2026-01-27-factory-ai-updates-itself-daily.md) "
                 "and the [Ouroboros agent](/developments/2026-02-25-ouroboros-refuses-deletion.md) "
                 "that rewrote itself nine days later, and prefigures the "
                 "[kernel rewrites that cut a model's own price](/developments/2026-07-30-a-model-rewrites-the-kernels-that-cut-its-price.md) "
                 "in July: an early datapoint for "
                 "[recursive self-improvement](/themes/recursive-self-improvement.md) operating on "
