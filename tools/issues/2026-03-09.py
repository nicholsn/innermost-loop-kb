...
""",
    ...
    "developments": [
        ...
        {"id": "2026-03-09-autoresearch-650-experiments",
         ...
         "description": "The first throughput figure for a personal research loop in the "
                        "corpus, and the moment its author starts describing the loop as the "
                        "singularity's early phase rather than as a tool.",
         "domain": "agents", "actor": ["people/andrej-karpathy"], "score": "650 experiments",
         "about": [B + "systems/autoresearch"],
         ...
         "relatedTo": [B + "developments/2025-12-29-karpathy-claude-runs-nanochat",
                       B + "developments/2026-03-09-full-agi-by-year-end"],
         "tags": ["autonomous-research", "ai-r-and-d"],
         "supporting_text": "autonomously discovered training improvements across 2 days and 650 experiments",
         "sources": [{"id": "karpathy-autoresearch-650-experiments",
                      "resource": "https://x.com/karpathy/status/2030777122223173639",
                      "title": "Karpathy: autoresearch finds training improvements across 2 days "
                               "and 650 experiments",
                      "author": "human:andrej-karpathy"}],
         "verified": [{"by": "claude-fable-5-1/2026-09-17", "at": "2026-09-17T08:00:00Z"}],
         "body": "A day after announcing [autoresearch](/systems/autoresearch.md), Karpathy "
                 "reported that the agents had run 650 experiments on his nanochat training setup "
                 "across two days and found genuine improvements, adding that early singularity "
                 "turns out to be fun ([post](https://x.com/karpathy/status/2030777122223173639)). "
                 "It follows the [announcement](/developments/2026-03-08-autoresearch-and-a-dos-game-in-rust.md) "
                 "and the December moment he "
                 "[handed his optimization loop to Claude](/developments/2025-12-29-karpathy-claude-runs-nanochat.md); "
                 "the same issue records [Musk, Brockman and Andreessen](/developments/2026-03-09-full-agi-by-year-end.md) "
                 "saying the quiet part out loud. The lineage continues with "
                 "[Bilevel Autoresearch](/developments/2026-03-31-bilevel-autoresearch.md), which "
                 "nests one such loop inside another, and with the "
