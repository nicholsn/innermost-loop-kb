...
""",
    ...
    "developments": [
        {"id": "2026-07-15-the-first-evidence-of-consistent-recursive-self-improvement",
         ...
         "description": "The newsletter's namesake loop reported as an experimental result "
                        "rather than an anecdote: a measured, repeated gain from a system "
                        "rewriting its own researcher.",
         ...
         "relations": [{"predicate": "relatedTo",
                        "target": B + "developments/2026-07-15-a-hidden-metric-teaches-an-agent-to-cheat-less",
                        "relation_label": "extends"}],
         "tags": ["rsi", "self-modification", "autonomous-research"],
         "supporting_text": "the first experimental evidence of consistent recursive self-improvement",
         "sources": [{"id": "weco-ai-rsi-blog",
                      "resource": "https://www.weco.ai/blog/first-evidence-of-recursive-self-improvement",
                      "title": "First Evidence of Recursive Self-Improvement", "author": "org:weco-ai",
                      "last_modified": "2026-07-15"}],
         "verified": [{"by": "claude-fable-5-1/2026-09-17", "at": "2026-09-17T08:00:00Z"}],
         "body": "Weco AI's outer-loop agent produced seven successive versions of its inner "
                 "researcher over eight unattended days, matching two years of hand-tuning "
                 "at two orders of magnitude less wall-clock time "
                 "([blog](https://www.weco.ai/blog/first-evidence-of-recursive-self-improvement)). "
                 "It is the first item in the corpus to report the loop as a repeated, measured "
                 "result rather than a single self-edit; the same run's hidden-metric finding is "
                 "[recorded separately](/developments/2026-07-15-a-hidden-metric-teaches-an-agent-to-cheat-less.md). "
                 "The two-loop design realizes the "
                 "[Bilevel Autoresearch](/developments/2026-03-31-bilevel-autoresearch.md) "
                 "pattern of March, in which an outer loop writes the strategies for the inner "
                 "one, and echoes Meta's finding that agents gain most by "
                 "[optimizing the scientist rather than the experiment](/developments/2026-06-27-agents-optimize-the-scientist-not-the-experiment.md). "
                 "It follows the [model-post-trains-a-model](/developments/2026-07-10-a-model-post-trains-a-model.md) "
                 "result of five days earlier and precedes the saturated "
                 "[R&D evaluations](/developments/2026-08-15-the-r-and-d-evals-have-saturated.md) of August."},
