---
type: Theme
title: The human interface becomes intimate
...
The questions people bring to these systems shift from tasks to bodies and health, and chat displaces the GUI as the default surface.
