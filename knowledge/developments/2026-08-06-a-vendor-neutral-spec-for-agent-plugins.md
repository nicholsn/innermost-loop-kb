...
claim: OpenAI published Agent Plugins, a vendor-neutral spec packing Skills and MCP servers into bundles any client can load, steered by Amazon, Cursor, Microsoft and Vercel.
domain: agents
reported_in:
  - https://nicholsn.github.io/innermost-loop-kb/issues/2026-08-06
actor:
