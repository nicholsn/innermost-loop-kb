...
claim: DeepSeek introduced Manifold-Constrained Hyper-Connections, expanding the residual stream into parallel projections for better performance at no extra compute.
domain: models
reported_in:
