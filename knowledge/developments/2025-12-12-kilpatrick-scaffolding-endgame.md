...
claim: Google's Logan Kilpatrick suggested superintelligence will arrive not as a new model but as existing weights unlocked by better scaffolding.
domain: agents
reported_in:
...
A claim about where progress comes from, and the sharpest statement of the issue's second theme.
