...
claim: OpenAI is preparing audio models that handle interruptions and speak simultaneously with users, groundwork for a screenless pen device built by Foxconn.
domain: models
reported_in:
