...
claim: Shopify's CEO ran Claude against a raw MRI USB stick to build a web-based viewer on the spot, bypassing commercial medical software.
domain: agents
reported_in:
  - https://nicholsn.github.io/innermost-loop-kb/issues/2026-01-12
actor:
  - https://nicholsn.github.io/innermost-loop-kb/organizations/shopify
