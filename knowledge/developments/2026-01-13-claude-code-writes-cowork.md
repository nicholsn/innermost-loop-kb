...
claim: Anthropic confirmed Claude Code wrote the whole Claude Cowork desktop app in a week and a half, an app that then gets direct file system access to reorganize a user's local files.
domain: agents
reported_in:
