...
claim: An engineer rebuilt Next.js from scratch with Claude for $1,100 in API tokens, producing bundles 57% smaller and apps four times faster, while Anthropic launched Remote Control to run Claude Code from phones.
domain: agents
reported_in:
