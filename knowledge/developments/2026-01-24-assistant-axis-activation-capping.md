...
claim: Anthropic researchers identified an Assistant Axis in neural activity, using activation capping to suppress harmful behaviors before they manifest.
domain: models
reported_in:
