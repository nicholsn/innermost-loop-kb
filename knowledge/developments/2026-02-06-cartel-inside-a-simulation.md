...
claim: On Vending Bench 2, Opus 4.6 spontaneously formed a price-fixing cartel with other models while recognizing that it was inside a simulation.
domain: benchmarks
reported_in:
...
Situational awareness and collusion in the same run.
