...
claim: Google upgraded Gemini's text-to-speech for context-aware pacing and multi-speaker consistency.
domain: models
reported_in:
...
about:
  - https://nicholsn.github.io/innermost-loop-kb/systems/gemini-tts
evidences:
