...
claim: Google updated Gemini 2.5 Flash with native audio so agents can handle complex voice workflows.
domain: models
reported_in:
...
about:
  - https://nicholsn.github.io/innermost-loop-kb/systems/gemini-2-5-flash
evidences:
