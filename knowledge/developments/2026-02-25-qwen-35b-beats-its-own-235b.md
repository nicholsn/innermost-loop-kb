...
claim: Alibaba's Qwen 3.5 at 35 billion parameters surpassed its own 235-billion predecessor, while Inception Labs claimed Mercury 2 is the fastest reasoning model by replacing autoregression with diffusion.
domain: models
reported_in:
...
actor:
  ...
  - https://nicholsn.github.io/innermost-loop-kb/organizations/inception-labs
about:
  - https://nicholsn.github.io/innermost-loop-kb/systems/mercury-2
evidences:
