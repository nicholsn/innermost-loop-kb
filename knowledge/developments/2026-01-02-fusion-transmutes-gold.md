...
claim: Marathon Fusion calculated that reactors could double revenue by transmuting mercury into gold with neutron multipliers.
domain: energy
reported_in:
  - https://nicholsn.github.io/innermost-loop-kb/issues/2026-01-02
actor:
  - https://nicholsn.github.io/innermost-loop-kb/organizations/marathon-fusion
evidences:
